...
export const relatedToolSlugsMap: Record<string, string[]> = {
  ...
  'html-formatter': ['xml-formatter', 'html-entity-encoder', 'markdown-preview', 'meta-tag-generator', 'text-diff'],
  ...
  'url-parser': ['url-encoder', 'utm-builder', 'qr-code-generator', 'json-formatter', 'serp-snippet-preview'],
  ...
  'utm-builder': ['url-parser', 'serp-snippet-preview', 'meta-tag-generator', 'qr-code-generator', 'url-encoder'],
  'robots-txt-generator': [
    'meta-tag-generator',
    'serp-snippet-preview',
    'open-graph-preview',
